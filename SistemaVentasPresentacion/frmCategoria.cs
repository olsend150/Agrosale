...
namespace SistemaVentasPresentacion
{
    public partial class frmCategoria : Form
    {
        ...
        private void frmCategoria_Load(object sender, EventArgs e)
        {
            ...
            //Pintar en data grid view los Categorias
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Esta seguro de eliminar esta categoria?", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
                    Categoria obj = new Categoria()
                    {
