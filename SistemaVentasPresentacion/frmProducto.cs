...
namespace SistemaVentasPresentacion
{
    public partial class frmProducto : Form
    {
        ...
        private void frmProducto_Load(object sender, EventArgs e)
        {
            ...
            //Pintar en data grid view los Productos
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Esta seguro de eliminar este producto?", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    string mensaje = string.Empty;
                    Producto obj = new Producto()
                    {
